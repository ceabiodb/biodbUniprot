...
list.classes:
	R $(RFLAGS) -e 'library(biodbUniprot) ; cat("Exported methods and classes:", paste(" ", ls("package:biodbUniprot"), collapse = "\n", sep = ""), sep = "\n")'
