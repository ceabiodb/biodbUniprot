...
date: "`r doc_date()`"
package: "`r pkg_ver('biodbUniprot')`"
abstract: |
  This vignette shows how to search for entries inside the UniProt database.
vignette: |
  %\VignetteIndexEntry{Searching for proteins.}
...
First we need to initialize *biodb* and create a connector to *UniProt*:
```{r, results='hide'}
mybiodb <- biodb::Biodb()
